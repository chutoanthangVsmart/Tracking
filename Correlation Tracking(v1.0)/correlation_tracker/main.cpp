...
//    }
    ...
    std::vector<file> files = get_files_in_directory_tree("/home/thangct2/Source/dlib/examples/video_frames", match_ending(".jpg"));
    ...
    tracker.start_track(img, centered_rect(point(40,190), 70, 75));
